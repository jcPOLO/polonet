...
from marshmallow import ValidationError, post_dump, post_load, pre_dump, pre_load, validates, fields
...
class JobSchema(ma.SQLAlchemyAutoSchema):
    class Meta:
        ...
        include_fk = True
        fields = ("id", "status", "started_at", "finished_at", "user_id", "inventory_id", "output")
